...
mod test_scalar_isa {
    ...
    #[test]
    fn test_add_reg_mul_i8_i8_i8_b_i8() {
        let prog = parse_from_file("examples/isa/scalar/add_reg_mul_i8_i8_i8_b_i8.ret");
    ...
    #[test]
    fn test_add_mul_i8_i8_i8_i8() {
        let prog = parse_from_file("examples/isa/scalar/add_mul_i8_i8_i8_i8.ret");
        let mut trace = Trace::default();
        trace.enq_scalar("a", 4);
        trace.enq_scalar("b", 2);
        trace.enq_scalar("c", 3);
    ...
    #[test]
    fn test_lut_add_i8_i8_i8() {
        let prog = parse_from_file("examples/isa/scalar/lut_add_i8_i8_i8.ret");
        let mut trace = Trace::default();
        trace.enq_scalar("a", -9);
        trace.enq_scalar("b", 3);
    ...
    #[test]
    fn test_dsp_add_i8_i8_i8() {
        let prog = parse_from_file("examples/isa/scalar/dsp_add_i8_i8_i8.ret");
        let mut trace = Trace::default();
        trace.enq_scalar("a", 20);
        trace.enq_scalar("b", 7);
    ...
    #[test]
    fn test_lut_and_i8_i8_i8() {
        let prog = parse_from_file("examples/isa/scalar/lut_and_i8_i8_i8.ret");
        let mut trace = Trace::default();
        trace.enq_scalar("a", 9);
    ...
    #[test]
    fn test_dsp_and_i8_i8_i8() {
        let prog = parse_from_file("examples/isa/scalar/dsp_and_i8_i8_i8.ret");
        let mut trace = Trace::default();
        trace.enq_scalar("a", 67);
        trace.enq_scalar("b", 9);
        trace.enq_scalar("y", 1);
        assert!(!Interpreter::default()
            .with_print()
            .run(&prog, &trace)
