        ...
        for instr in prog.body().iter() {
            ...
            if instr.is_phy() {
                match instr.phy().op().as_ref() {
                    ...
                    "lut_and_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_and_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_and_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_or_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_or_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_or_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_or_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_xor_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_xor_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_xor_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_xor_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_nand_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_nand_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_nand_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_nand_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_nor_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_nor_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_nor_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_nor_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_xnor_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_xnor_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_xnor_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_xnor_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_eq8_bool_r0" => isa::LutEq::emit(self, instr),
                    "lut_eq8_bool_r1" => isa::LutEq::emit(self, instr),
                    "lut_eq1_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_eq1_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_neq8_bool_r0" => isa::LutEq::emit(self, instr),
                    "lut_neq8_bool_r1" => isa::LutEq::emit(self, instr),
                    "lut_neq1_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_neq1_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_not_i8_r0" => isa::LutLogical::emit(self, instr),
                    "lut_not_i8_r1" => isa::LutLogical::emit(self, instr),
                    "lut_not_bool_r0" => isa::LutLogical::emit(self, instr),
                    "lut_not_bool_r1" => isa::LutLogical::emit(self, instr),
                    "lut_mux_i8_r0" => isa::LutMux::emit(self, instr),
                    "lut_mux_i8_r1" => isa::LutMux::emit(self, instr),
                    "lut_mux_bool_r0" => isa::LutMux::emit(self, instr),
                    "lut_mux_bool_r1" => isa::LutMux::emit(self, instr),
                    "lut_reg_i8" => isa::LutReg::emit(self, instr),
                    "dsp_add_i8v4_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_add_i8v4_r0_r0_r1" => isa::DspAlu::emit(self, instr),
                    "dsp_add_i8v4_r1_r1_r1" => isa::DspAlu::emit(self, instr),
                    "dsp_sub_i8v4_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_add_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_sub_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_and_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_or_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_xor_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_nand_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_nor_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_xnor_i8_r0_r0_r0" => isa::DspAlu::emit(self, instr),
                    "dsp_add_i8_r0_r0_r1" => isa::DspAlu::emit(self, instr),
                    "dsp_mul_i8_r0_r0_r0" => isa::DspMulAlu::emit(self, instr),
                    "dsp_muladd_i8_r0_r0_r0_r0_r0_a_b_c" => isa::DspMulAlu::emit(self, instr),
                    "dsp_muladd_i8_r0_r0_r0_r1_r0_a_b_c" => isa::DspMulAlu::emit(self, instr),
                    "dsp_muladd_i8_r1_r1_r0_r1_r1_a_b_c" => isa::DspMulAlu::emit(self, instr),
                    "dsp_muladd_i8_r1_r1_r0_r1_r1_c_a_b" => isa::DspMulAlu::emit(self, instr),
                    _ => unimplemented!(),
                }
            } else {
                match instr.std().op() {
                    asm::StdOp::Const => isa::Constant::emit(self, instr),
                    asm::StdOp::Identity => isa::Identity::emit(self, instr),
                    _ => unimplemented!(),
                }
            }
        }
