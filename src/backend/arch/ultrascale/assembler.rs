        ...
        for instr in prog.body().iter() {
            ...
            if instr.is_prim() {
                match instr.prim().op().as_ref() {
                    ...
                    "dsp_sub_i8_r0_r0_r0" => isa::DspArith::emit(self, instr),
                    "dsp_and_i8_r0_r0_r0" => isa::DspArith::emit(self, instr),
                    "dsp_or_i8_r0_r0_r0" => isa::DspArith::emit(self, instr),
                    "dsp_xor_i8_r0_r0_r0" => isa::DspArith::emit(self, instr),
