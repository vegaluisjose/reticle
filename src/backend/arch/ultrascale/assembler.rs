        ...
        for instr in prog.body().iter() {
            ...
            if instr.is_prim() {
                match instr.prim().op().as_ref() {
                    ...
                    "dsp_muladd_i8_r0_r0_r0_r0_r0_a_b_c" => isa::DspFusedArith::emit(self, instr),
                    "dsp_muladd_i8_r0_r0_r0_r1_r0_a_b_c" => isa::DspFusedArith::emit(self, instr),
                    "dsp_mul_i8_r0_r0_r0" => isa::DspFusedArith::emit(self, instr),
